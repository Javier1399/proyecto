...
public:
    ...
    Trabajador(string nombre, int id, int horas) : nombre(nombre), id(id), horas_trabajadas(horas) {}
...
public:
    ...
    TrabajadorBase(string nombre, int id, int horas) : Trabajador(nombre, id, horas) {}
...
public:
    ...
    Gerente(string nombre, int id, int horas, double sueldo) : Trabajador(nombre, id, horas), sueldo(sueldo) {}
